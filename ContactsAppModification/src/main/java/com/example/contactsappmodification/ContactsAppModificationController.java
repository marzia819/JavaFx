...
public class ContactsAppModificationController {
    ...
    public void initialize() {
        ...
        contacts.add(new Contact("Zakir", "Hussain", "zakirmoradi@gmail.com", "07005234234", "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Image_created_with_a_mobile_phone.png/640px-Image_created_with_a_mobile_phone.png"));
